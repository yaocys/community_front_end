        ...
        <div id="carouselIndicators" className="carousel slide">
            ...
            <div className="carousel-inner">
                <div className="carousel-item active">
                    <img src="/pic/PC.jpg" className="d-block w-100" alt="..."/>
                </div>
                <div className="carousel-item">
                    <img src="/pic/Platinum.jpg" className="d-block w-100" alt="..."/>
                </div>
                <div className="carousel-item">
                    <img src="/pic/Sandstone.jpg" className="d-block w-100" alt="..."/>
                </div>
            </div>
